...
-->  
  ...
  <xsl:choose>
    ...
    <xsl:when test="@name = '__EVENTTARGET'">
      <xsl:value-of select="@name"/>=ctl00$ctl00$ContentPlaceholderColumnTwo$ContentPlaceholderPageContent$PageContentControl$ProductModuleControl$btnChangeWeb&#38;<xsl:text></xsl:text>
    </xsl:when>
